...
-- // Functions
	...
	do
		...
		function Library:updateNotifsPositions(position)
			for i, v in pairs(Library.Notifs) do 
				...
				cloneref(game:GetService("TweenService")):Create(v.Container, TweenInfo.new(0.25, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Position = UDim2.new(0,Position.X,0,Position.Y + (i * 25))}):Play()
			end 
		end
		-- 
		function Library:Notification(message, duration, color, position)
			...
			-- 
			local NotifContainer = cloneref(Instance.new('Frame', NotifiactionSGui))
			local Background = cloneref(Instance.new('Frame', NotifContainer))
			local Outline = cloneref(Instance.new('Frame', Background))
			local UIStroke = cloneref(Instance.new('UIStroke', Outline))
			local TextLabel = cloneref(Instance.new('TextLabel', Background))
			local Accemt = cloneref(Instance.new('Frame', Background))
			local Progress = cloneref(Instance.new('Frame', Background))
			--
			...
			task.spawn(function()
				...
				local Tween1 = cloneref(game:GetService("TweenService")):Create(Background, TweenInfo.new(0.25, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {AnchorPoint = NewVector2(0,0)}):Play()
				local Tween2 = cloneref(game:GetService("TweenService")):Create(Progress, TweenInfo.new(duration or 5, Enum.EasingStyle.Linear, Enum.EasingDirection.Out), {Size = UDim2.new(1,0,0,1)}):Play()
				cloneref(game:GetService("TweenService")):Create(Progress, TweenInfo.new(duration or 5, Enum.EasingStyle.Linear, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.new(0,1,0)}):Play()
				task.wait(duration)
				cloneref(game:GetService("TweenService")):Create(Background, TweenInfo.new(0.25, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {AnchorPoint = NewVector2(1,0)}):Play()
				for i,v in next, notification.Objects do
					cloneref(game:GetService("TweenService")):Create(v, TweenInfo.new(0.25, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundTransparency = 1}):Play()
				end
				cloneref(game:GetService("TweenService")):Create(TextLabel, TweenInfo.new(0.25, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextTransparency = 1}):Play()
				cloneref(game:GetService("TweenService")):Create(UIStroke, TweenInfo.new(0.25, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Transparency = 1}):Play()
			end)
		...
		function Library:KeybindList()
			...
			--
			local KeyOutline = cloneref(Instance.new('Frame', PlaceHolderUI))
			local KeyInline = cloneref(Instance.new('Frame', KeyOutline))
			local KeyAccent = cloneref(Instance.new('Frame', KeyInline))
			local KeyHolder = cloneref(Instance.new('Frame', KeyInline))
			local UIListLayout = cloneref(Instance.new('UIListLayout', KeyHolder))
			local KeyTitle = cloneref(Instance.new('TextLabel', KeyInline))
			local LineThing = cloneref(Instance.new('Frame', KeyInline))
			--
			...
			function KeyList:NewKey(Name, Key, Mode)
				local KeyValue = {}
				--
				local NewValue = cloneref(Instance.new('TextLabel', KeyHolder))
				--
	...
	do
		function Library:NewPicker(name, default, defaultalpha, parent, count, flag, callback)
			-- // Instances
			local Icon = cloneref(Instance.new('TextButton', parent))
			local IconInline = cloneref(Instance.new('Frame', Icon))
			local ColorWindow = cloneref(Instance.new('Frame', parent))
			local WindowInline = cloneref(Instance.new('Frame', ColorWindow))
			local Color = cloneref(Instance.new('TextButton', WindowInline))
			local Sat = cloneref(Instance.new('ImageLabel', Color))
			local Val = cloneref(Instance.new('ImageLabel', Color))
			local Pointer = cloneref(Instance.new('Frame', Color))
			local Container = cloneref(Instance.new('Frame', Color))
			local ColorOutline = cloneref(Instance.new('Frame', Color))
			local UIStroke = cloneref(Instance.new('UIStroke', ColorOutline))
			local Hue = cloneref(Instance.new('ImageButton', Color))
			local HueOutline = cloneref(Instance.new('Frame', Hue))
			local UIStroke2 = cloneref(Instance.new('UIStroke', HueOutline))
			local Alpha = cloneref(Instance.new('ImageButton', Color))
			local AlphaOutline = cloneref(Instance.new('Frame', Alpha))
			local UIStroke3 = cloneref(Instance.new('UIStroke', AlphaOutline))
			local HueSlide = cloneref(Instance.new('Frame', Hue))
			local AlphaSlide = cloneref(Instance.new('Frame', Alpha))
			local ModeOutline = cloneref(Instance.new('Frame', parent))
			local ModeInline = cloneref(Instance.new('Frame', ModeOutline))
			local UIListLayout = cloneref(Instance.new('UIListLayout', ModeInline))
			local Hold = cloneref(Instance.new('TextButton', ModeInline))
			local Toggle = cloneref(Instance.new('TextButton', ModeInline))
			--
			Icon.Name = "Icon"
			...
			local function update()
				local real_pos = cloneref(game:GetService("UserInputService")):GetMouseLocation()
			...
			Library:Connection(cloneref(game:GetService("UserInputService")).InputChanged, function(input)
			...
			--
			Library:Connection(cloneref(game:GetService("UserInputService")).InputBegan, function(Input)
	...
	do
		...
		function Library:Window(Options)
			...
			--
			local ScreenGui = cloneref(Instance.new('ScreenGui', game.CoreGui))
			local Outline = cloneref(Instance.new('Frame', ScreenGui))
			local Inline = cloneref(Instance.new('Frame', Outline))
			local Accent = cloneref(Instance.new('Frame', Inline))
			local HolderOutline = cloneref(Instance.new('Frame', Inline))
			local HolderInline = cloneref(Instance.new('Frame', HolderOutline))
			local Tabs = cloneref(Instance.new('Frame', HolderInline))
			local UIListLayout = cloneref(Instance.new('UIListLayout', Tabs))
			local DragButton = cloneref(Instance.new('TextButton', Outline))
			...
			Library:Connection(DragButton.MouseButton1Down, function()
				local Location = cloneref(game:GetService("UserInputService")):GetMouseLocation()
			...
			Library:Connection(cloneref(game:GetService("UserInputService")).InputEnded, function(Input)
		...
		function Library:Page(Properties)
			...
			--
			local TabButton = cloneref(Instance.new('TextButton', Page.Window.Elements.TabHolder))
			local TabAccent = cloneref(Instance.new('Frame', TabButton))
			local TabLine = cloneref(Instance.new('Frame', TabButton))
            local WeaponOutline = cloneref(Instance.new("Frame", Page.Window.Elements.Holder))
            local WeaponInline = cloneref(Instance.new("Frame", WeaponOutline))
            local UIListLayout3 = cloneref(Instance.new("UIListLayout", WeaponInline))
            local Left = cloneref(Instance.new('Frame', Page.Window.Elements.Holder))
            local Right = cloneref(Instance.new('Frame', Page.Window.Elements.Holder))
            local UIListLayout = cloneref(Instance.new('UIListLayout', Left))
            local UIListLayout_2 = cloneref(Instance.new('UIListLayout', Right))
            Left.Name = "Left"
        ...
        function Pages:Weapon(Properties)
			...
			local Left = cloneref(Instance.new('Frame', Weapon.Window.Window.Elements.Holder))
			local Right = cloneref(Instance.new('Frame', Weapon.Window.Window.Elements.Holder))
			local UIListLayout = cloneref(Instance.new('UIListLayout', Left))
			local UIListLayout_2 = cloneref(Instance.new('UIListLayout', Right))
            local New = cloneref(Instance.new("ImageButton"))
			--
			New.Name = "New"
		...
		function Pages:Section(Properties)
			...
			--
			local SectionOutline = cloneref(Instance.new('Frame', Section.Side == "left" and Section.Page.Elements.Left or Section.Side == "right" and Section.Page.Elements.Right))
			local SectionInline = cloneref(Instance.new('Frame', SectionOutline))
			local Container = cloneref(Instance.new('Frame', SectionInline))
			local UIListLayout = cloneref(Instance.new('UIListLayout', Container))
			local Space = cloneref(Instance.new('Frame', Container))
			local SectionAccent = cloneref(Instance.new('Frame', SectionInline))
			local Title = cloneref(Instance.new('TextLabel', SectionOutline))
			local TextBorder = cloneref(Instance.new('Frame', SectionOutline)	)
			--
		...
		function Sections:Toggle(Properties)
			...
			--
			local NewToggle = cloneref(Instance.new('TextButton', Toggle.Section.Elements.SectionContent))
			local Outline = cloneref(Instance.new('Frame', NewToggle))
			local Inline = cloneref(Instance.new('Frame', Outline))
			local Title = cloneref(Instance.new('TextLabel', NewToggle))
			--
			...
			function Toggle:Keybind(Properties)
				...
				local State = false
				--
				local Outline = cloneref(Instance.new('TextButton', NewToggle))
				local Inline = cloneref(Instance.new('Frame', Outline))
				local Value = cloneref(Instance.new('TextLabel', Inline))
				local ModeOutline = cloneref(Instance.new('Frame', NewToggle))
				local ModeInline = cloneref(Instance.new('Frame', ModeOutline))
				local UIListLayout = cloneref(Instance.new('UIListLayout', ModeInline))
				local Hold = cloneref(Instance.new('TextButton', ModeInline))
				local Toggle = cloneref(Instance.new('TextButton', ModeInline))
				local Always = cloneref(Instance.new('TextButton', ModeInline))
				...
				Outline.MouseButton1Click:Connect(function()
					if not Keybind.Binding then
						...
						Keybind.Binding = Library:Connection(
							cloneref(game:GetService("UserInputService")).InputBegan,
							function(input, gpe)
								set(
				...
				--
				local HoldLoop; 
				Library:Connection(cloneref(game:GetService("UserInputService")).InputBegan, function(inp, Typing)
					...
					if (inp.KeyCode == Key or inp.UserInputType == Key) and not Keybind.Binding then
						if Keybind.Mode == "Hold" then
							...
							HoldLoop = Library:Connection(cloneref(game:GetService("RunService")).RenderStepped, function()
				...
				--
				Library:Connection(cloneref(game:GetService("UserInputService")).InputEnded, function(inp, Typing)
					if Typing then return end 
					if Keybind.Mode == "Hold" then
		...
		function Sections:Slider(Properties)
			...
			--
			local NewSlider = cloneref(Instance.new('TextButton', Slider.Section.Elements.SectionContent))
			local Outline = cloneref(Instance.new('Frame', NewSlider))
			local Inline = cloneref(Instance.new('Frame', Outline))
			local Accent = cloneref(Instance.new('TextButton', Inline))
			local Add = cloneref(Instance.new('TextButton', Outline))
			local Subtract = cloneref(Instance.new('TextButton', Outline))
			local Title = cloneref(Instance.new('TextLabel', NewSlider))
			local Value = cloneref(Instance.new('TextLabel', NewSlider))
			--
		...
		function Sections:Dropdown(Properties)
			...
			--
			local NewDrop = cloneref(Instance.new('Frame', Dropdown.Section.Elements.SectionContent))
			local Outline = cloneref(Instance.new('TextButton', NewDrop))
			local Inline = cloneref(Instance.new('Frame', Outline))
			local Value = cloneref(Instance.new('TextLabel', Inline))
			local Icon = cloneref(Instance.new('TextLabel', Inline))
			local Title = cloneref(Instance.new('TextLabel', NewDrop))
			local ContainerOutline = cloneref(Instance.new('Frame', NewDrop))
			local ContainerInline = cloneref(Instance.new('Frame', ContainerOutline))
			local UIListLayout = cloneref(Instance.new('UIListLayout', ContainerInline))
			--
			...
			local function createoptions(tbl)
				for _, option in next, tbl do
					...
					local NewOption = cloneref(Instance.new('TextButton', ContainerInline))
					local OptionName = cloneref(Instance.new('TextLabel', NewOption))
		...
		function Sections:Keybind(Properties)
			...
			local State = false
			--
			local NewKey = cloneref(Instance.new('Frame', Keybind.Section.Elements.SectionContent))
			local Outline = cloneref(Instance.new('TextButton', NewKey))
			local Inline = cloneref(Instance.new('Frame', Outline))
			local Value = cloneref(Instance.new('TextLabel', Inline))
			local Title = cloneref(Instance.new('TextLabel', NewKey))
			local ModeOutline = cloneref(Instance.new('Frame', NewKey))
			local ModeInline = cloneref(Instance.new('Frame', ModeOutline))
			local UIListLayout = cloneref(Instance.new('UIListLayout', ModeInline))
			local Hold = cloneref(Instance.new('TextButton', ModeInline))
			local Toggle = cloneref(Instance.new('TextButton', ModeInline))
			...
			--
			Library:Connection(cloneref(game:GetService("UserInputService")).InputBegan, function(inp, Chatting)
				if not Chatting then 
					if (inp.KeyCode == Key or inp.UserInputType == Key) and not Keybind.Binding and not Keybind.UseKey then
						if Keybind.Mode == "Hold" then
							...
							c = Library:Connection(cloneref(game:GetService("RunService")).RenderStepped, function()
								if Keybind.Callback then
									Keybind.Callback(true)
								end
							end)
			...
			--
			Library:Connection(cloneref(game:GetService("UserInputService")).InputEnded, function(inp, Chatting)
				if not Chatting then 
			...
			--
			Library:Connection(cloneref(game:GetService("UserInputService")).InputBegan, function(Input, Chatting)
				if ModeOutline.Visible and Input.UserInputType == Enum.UserInputType.MouseButton1 then
					if not Library:IsMouseOverFrame(ModeOutline) then
						ModeOutline.Visible = false
					end
		...
		function Sections:Colorpicker(Properties)
			...
			--
			local NewToggle = cloneref(Instance.new('Frame', Colorpicker.Section.Elements.SectionContent))
			local TextLabel = cloneref(Instance.new('TextLabel', NewToggle))
			--
			NewToggle.Name = "NewToggle"
			NewToggle.Size = UDim2.new(1,0,0,10)
			NewToggle.BackgroundColor3 = Color3.new(1,1,1)
		...
		function Sections:Textbox(Properties)
			...
			--
			local NewDrop = cloneref(Instance.new('Frame', Textbox.Section.Elements.SectionContent))
			local Outline = cloneref(Instance.new('TextButton', NewDrop))
			local Inline = cloneref(Instance.new('Frame', Outline))
			local Value = cloneref(Instance.new('TextBox', Inline))
			local Title = cloneref(Instance.new('TextLabel', NewDrop))
			--
			NewDrop.Name = "NewDrop"
			NewDrop.Size = UDim2.new(1,0,0,30)
		...
		function Sections:Button(Properties)
			...
			--
			local NewButton = cloneref(Instance.new('TextButton', Button.Section.Elements.SectionContent))
			local Outline = cloneref(Instance.new('Frame', NewButton))
			local Inline = cloneref(Instance.new('Frame', Outline))
			local Value = cloneref(Instance.new('TextLabel', Inline))
			--
		...
		function Sections:Label(Properties) -- fuck finobe
			...
			local NewButton = cloneref(Instance.new('TextLabel', Label.Section.Elements.SectionContent)) -- ya im lazy
			--
			NewButton.Name = "NewButton"
